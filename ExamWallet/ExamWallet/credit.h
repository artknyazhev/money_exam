...
public:
	...
	void GetTopMonth(int mon) {
		...
		int cat = 0;
		int index;
		ofstream fout("crating.txt", ios::app);
...
private:
	...
	vector <string> files = { "cfood.txt","chealth.txt","cfun.txt","ctech.txt","ctrans.txt","ccafe.txt" };
